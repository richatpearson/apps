...
/*!
 Deletes the stored token and credentials for the Pi user associated with this client.
 
 @return Indicates if the token was successfully deleted.
 */
- (BOOL) logout;

/*!
 Indicates if the Pi user associated with this client is currently logged out.
