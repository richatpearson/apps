...
extern NSString* const PGMPiUserIdPath_Staging;
extern NSString* const PGMPiUserIdPath_Prod;

extern NSString* const PGMPiRefreshPath_Staging;
extern NSString* const PGMPiRefreshPath_Prod;
