...
# WORK IN PROGRESS for PEARSON GRID DOCS
...
# it to ~/Library/Developer/Shared/Documentation/DocSets/com.pearson.documentation.ios_sdk.docset
...
DOCUMENT_DIR=./build/docs/headerdocs
...
SOURCE_DIR=../framework/src/xcode/PushNotifications
