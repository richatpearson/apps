//
//  PearsonDeviceUserConnectionOperation.h
...
@protocol PearsonDeviceUserConnectionDelegate <NSObject>
@optional
...
@interface PearsonDeviceUserConnectionOperation : NSOperation <PearsonClientDelegate>

@property (nonatomic, assign) PearsonDataClient* dataClient;
@property (nonatomic, strong) NSString* userId;

@property (nonatomic, assign) id<PearsonDeviceUserConnectionDelegate> delegate;
